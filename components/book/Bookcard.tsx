    ...
    return (
        <View className="w-60 h-[460] mr-3 bg-white rounded-lg border border-gray-200 shadow-md overflow-hidden">
            ...
            <View className="flex-2 p-4">
                <Text className="text-xl font-abld" numberOfLines={1}>{title}</Text>
                <Text className="text-base text-gray-600" numberOfLines={1}>{author}</Text>
                <View className="bg-primary-light rounded-md px-2 py-1 mt-1 self-start">
                    <Text className="text-sm font-abld text-gray-800">{genre}</Text>
                </View>
            </View>
        </View>
    );
