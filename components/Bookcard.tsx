      ...
      <TouchableOpacity activeOpacity={0.5}>
        <View className="w-60 h-[460] mr-3 bg-white dark:bg-slate-800 rounded-lg border border-[#b4541329] shadow-md overflow-hidden">
          ...
          <View className="flex-2 p-4">
            <Text
              className="text-lg font-abld text-slate-900 dark:text-slate-50"
              numberOfLines={1}
            >
              {title}
            </Text>
            ...
            <View className="bg-slate-200 dark:bg-slate-600 rounded-md px-2 py-1 mt-1 self-start">
              <Text className="text-xs font-abld text-slate-800 dark:text-slate-200">
                {genre}
              </Text>
            </View>
          </View>
