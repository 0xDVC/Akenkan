...
export default function SignUp() {
    ...
    return (
      ...
      <>
        <ScrollView className="bg-background-light dark:bg-slate-800">
          <View className="w-full px-4 my-6 justify-center h-full">
            <Text className="dark:text-slate-200 font-abld text-center text-5xl mt-[15px]">
              Sign Up
            </Text>
            <Text className="dark:text-slate-50  font-sreg text-center text-lg mt-4 ">
            ...
            <FormField
              ...
              otherStyles="mt-4"
            />
            <Text className="dark:text-slate-50 text-gray-650 font-smed text-base mt-6">
              Gender
            </Text>
            ...
            <View className="flex-row items-center ">
              ...
              <Text className="dark:text-slate-50 mx-4 text-gray-500 font-sreg text-xl">
                or
              </Text>
              <View className="flex-1 h-px bg-gray-300" />
            </View>
            ...
            <View className="mt-4 justify-center items-center">
              <Text className="dark:text-slate-50 font-smed text-lg">
